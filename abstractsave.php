				...
				<div class="row page-header-content-inner">
					...
					<div class="col-lg-6 p-0 ">
						...
						<div class="register-form">
							...
							$target_dir = "uploads/";
							$target_file = $target_dir . date("mdhisa") . basename($_FILES["fileToUpload"]["name"]);
							$uploadOk = 1;
							...
							if ($_FILES["fileToUpload"]["size"] > 5120000) {
							  echo "Sorry, your file is too large. Maximum file size must be 5MB";
							  $uploadOk = 0;
							}
							...
							// if everything is ok, try to upload file
							  ...
							  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
								echo "<h3>The file ". htmlspecialchars( basename( $_FILES["fileToUpload"]["name"])). " has been uploaded.</h3>";
									if (mysqli_query($mysqli, "INSERT INTO `abstract`(`EmailAddress`, `FullName`, `Address`, `Country`, `CellNumber`, `FileName`) 
										VALUES ('".$email."','".$name."','".$address."','".$country."','".$number."','".$target_file."')")){
										echo "<h3>Hooray! Registration Completed Successfully</h3>";
									}else{
										echo "<h3>Oh No! Error Occurred. Registration Not Completed.</h3>";
									}
							  } else {
